...
class Login_Button {
	...
	public function render_on_login_form(): void {
		...
		echo $this->render( __( 'Sign in with Telegram', 'telegram-auth' ), '' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- render() escapes its own output.
	}
